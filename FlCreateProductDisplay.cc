...
FlCreateProductDisplay::FlCreateProductDisplay(int x, int y, int w, int h)
    ...
    btnCancel = new Fl_Button(DCX(53),DCY(32),48,20,"clear");
    set_winny_button_theme(btnCancel);

    holrule1 = new Fl_Box(DCX(34),DCY(251),390,1,"Components");
    ...
    components  = new dataset_view(DCX(38),DCY(285),390,121);  
    components->box(WINNY_TOP_BORDERBOX);     
   
    holrule2 = new Fl_Box(DCX(38),DCY(192),390,1);
    holrule2->box(WINNY_TOP_BORDERBOX); 

    holrule3 = new Fl_Box(DCX(0),DCY(65),w,1);
    holrule3->box(WINNY_TOP_BORDERBOX); 

    resizer = new Fl_Box(DCX(488),DCY(382),14,1);
    resizable(resizer);
    end();
};
